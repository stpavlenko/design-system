import { visualTestEnv } from './testplane-tools/visualTestEnv';
import { renderCommand, assertPageViewCommand } from './testplane-tools/testsServer/render';
...
module.exports = {
	...
	browsers: {
		chrome: {
			...
			gridUrl: visualTestEnv.selenoidUrl,
			windowSize: {
				width: 1280,
				height: 800,
			},
	...
	prepareBrowser: async (browser: WebdriverIO.Browser) => {
		...
		browser.addCommand('assertPageView', assertPageViewCommand);
	},
